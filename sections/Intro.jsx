    ...
    <Fragment>
      ...
      <section id='home'>
        ...
        >
          ...
          >
            ...
            <div className='mt-5 md:mt-10 flex gap-3'>
              ...
              <Link
                ...
                href='https://drive.google.com/file/d/13K84VBayOeKsD8SpatBVQAuc-AJMQz2H/view?usp=drive_link'
                target='_blank'
              >
                Download CV
              </Link>
          ...
          <div
            className={
              "translate-x-[500px] transition-all opacity-0 duration-700 w-[180px] h-[300px] md:w-[400px] md:h-[500px] bg-cover m-auto md:m-0 mt-[40px] md:mt-0 bg-no-repeat"
            }
            ref={profileRef}
            style={{ backgroundImage: "url(/images/sticker.png )" }}
          />
        </div>
      </section>
    </Fragment>
